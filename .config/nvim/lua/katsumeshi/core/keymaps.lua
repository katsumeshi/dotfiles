...
keymap.set("n", "<M-h>", "<C-w><", { desc = "Decrease the width of the current split" })
keymap.set("n", "<M-l>", "<C-w>>", { desc = "Increase the width of the current split" })
keymap.set("n", "<M-k>", "<C-w>+", { desc = "Increase the height of the current split" })
keymap.set("n", "<M-j>", "<C-w>-", { desc = "Decrease the height of the current split" })
